import {Search,SearchIconWrapper,StyledInputBase,} from "@/styledComponents/SearchStyles";
    ...
    return (
      ...
      >
        ...
        <Select
            ...
            >
              <MenuItem value={1} disabled>VIEW TYPE</MenuItem>
